...
class Visualization:
    ...
    def makeWordCloud(self):
        alice_color_title = 'alice_color.png'
        alice_coloring = np.array(Image.open(alice_color_title))

        fontpath = "NanumBarunGothic.ttf"
        wordcloud = WordCloud(font_path=fontpath, background_color='lightyellow', mask=alice_coloring,
