...
myframeT.plot(title='지역별 차량 등록 대대수', kind='bar', rot=0, legend=True)
...
myframeT.plot(title='지역별 차량 등록 대대수', kind='bar', rot=0, legend=True, stacked=True ,ylim=(0, ymaxlimit))
