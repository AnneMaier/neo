...
print('\n #  notnull 함수 : Nan 이면 False')
print(myseries.notnull())
print("-" * 50)

print('\n #  notnull 함수 이용해서 참인 항목만 출력')
...
print('\n # dropna(how="all")이용 누락 데이터 처리 ')
cleaned = myframe.dropna(how="all")
print(cleaned)
print("-" * 50)

print('\n # dropna(how="any")이용 누락 데이터 처리 ')
...
print('\n # culumn기준, how="all"이용 누락 데이터 처리')
cleaned = myframe.dropna(axis=1, how="all")
print(cleaned)
print("-" * 50)

print('\n # culumn기준, how="any"이용 누락 데이터 처리')
